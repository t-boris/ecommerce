...
func (app *Application) GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := UserCollection.FindOne(ctx, bson.D{primitive.E{Key: "_id", Value: hexUserID}}).Decode(&filledCart)
		if err != nil {
			log.Println(err)
		...
		filterMatch := bson.D{{Key: "$match", Value: bson.D{primitive.E{Key: "_id", Value: hexUserID}}}}
